...
$this->title = '后台首页';
$this->params['breadcrumbs'][] = '<?= $table_comment; ?>添加';
<?php 
echo "?>\n";
?>
<!-- Content Header (Page header) -->
<section class="content-header">
  <h1><?= $table_comment; ?>添加</h1>
  <ol class="breadcrumb">
    <li><a href="#"><i class="fa fa-dashboard"></i> 首页</a></li>
    <li class="active"><?= $table_comment; ?>添加</li>
  </ol>
</section>
<!-- Main content -->
        ...
        <div class="box-inner">
            ...
            <div class="box-content">
	                ...
	                $form = ActiveForm::begin([
	                     'id' => 'add-form',
	                     'action' => Url::toRoute('<?= $view_name; ?>/add'),
	                ]);
	                <?php echo "?>\n";?>
...
<?php 
    ...
    file_put_contents($dir.'/add.php', $file);
?>