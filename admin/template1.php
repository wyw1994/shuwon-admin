...
imagefttext($dst, 30, 0, 373, 525, $green, $font, $groom);
imagefttext($dst, 30, 0, 373, 595, $red, $font, $bride);
//imagefttext($dst, 14, 0, 25, 450, $black, $font, '请帖既然发了，请饭是必须滴！');
//输出图片
